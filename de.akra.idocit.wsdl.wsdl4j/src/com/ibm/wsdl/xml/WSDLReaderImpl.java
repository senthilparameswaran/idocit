...
public class WSDLReaderImpl implements WSDLReader
{
                                          ...
                                          throws WSDLException
  {
    ...
    while (tempEl != null)
    {
      ...
      {
        def.addDocumentationElement(tempEl);
      }
                                 ...
                                 throws WSDLException
  {
    ...
    while (tempEl != null)
    {
      ...
      {
        importDef.addDocumentationElement(tempEl);
      }
      else
      {
    ...
    throws WSDLException
  {
    ...
    while (tempEl != null)
    {
      ...
      if (QNameUtils.matches(Constants.Q_ELEM_DOCUMENTATION, tempEl))
      {
        types.addDocumentationElement(tempEl);
      }
    ...
    throws WSDLException
  {
    ...
    while (tempEl != null)
    {
      if (QNameUtils.matches(Constants.Q_ELEM_DOCUMENTATION, tempEl))
      {
        binding.addDocumentationElement(tempEl);
      }
      ...
      throws WSDLException
  {
    ...
    while (tempEl != null)
    {
      if (QNameUtils.matches(Constants.Q_ELEM_DOCUMENTATION, tempEl))
      {
        bindingOperation.addDocumentationElement(tempEl);
      }
                                             ...
                                             throws WSDLException
  {
    ...
    while (tempEl != null)
    {
      if (QNameUtils.matches(Constants.Q_ELEM_DOCUMENTATION, tempEl))
      {
        bindingInput.addDocumentationElement(tempEl);
      }
      else
      {
                                               ...
                                               throws WSDLException
  {
    ...
    while (tempEl != null)
    {
      if (QNameUtils.matches(Constants.Q_ELEM_DOCUMENTATION, tempEl))
      {
        bindingOutput.addDocumentationElement(tempEl);
      }
      else
      {
                                             ...
                                             throws WSDLException
  {
    ...
    while (tempEl != null)
    {
      if (QNameUtils.matches(Constants.Q_ELEM_DOCUMENTATION, tempEl))
      {
        bindingFault.addDocumentationElement(tempEl);
      }
      else
      {
    ...
    throws WSDLException
  {
    ...
    while (tempEl != null)
    {
      if (QNameUtils.matches(Constants.Q_ELEM_DOCUMENTATION, tempEl))
      {
        msg.addDocumentationElement(tempEl);
      }
    ...
    throws WSDLException
  {
    ...
    while (tempEl != null)
    {
      if (QNameUtils.matches(Constants.Q_ELEM_DOCUMENTATION, tempEl))
      {
        part.addDocumentationElement(tempEl);
      }
      else
      {
    ...
    throws WSDLException
  {
    ...
    while (tempEl != null)
    {
      if (QNameUtils.matches(Constants.Q_ELEM_DOCUMENTATION, tempEl))
      {
        portType.addDocumentationElement(tempEl);
      }
      else if (QNameUtils.matches(Constants.Q_ELEM_OPERATION, tempEl))
      {
                                       ...
                                       throws WSDLException
  {
    ...
    if (docEl != null)
    {
      op.addDocumentationElement(docEl);
    }
    ...
    throws WSDLException
  {
    ...
    while (tempEl != null)
    {
      if (QNameUtils.matches(Constants.Q_ELEM_DOCUMENTATION, tempEl))
      {
        service.addDocumentationElement(tempEl);
      }
    ...
    throws WSDLException
  {
    ...
    while (tempEl != null)
    {
      if (QNameUtils.matches(Constants.Q_ELEM_DOCUMENTATION, tempEl))
      {
        port.addDocumentationElement(tempEl);
      }
      else
      {
    ...
    throws WSDLException
  {
    ...
    while (tempEl != null)
    {
      if (QNameUtils.matches(Constants.Q_ELEM_DOCUMENTATION, tempEl))
      {
        input.addDocumentationElement(tempEl);
      }
      else
      {
    ...
    throws WSDLException
  {
    ...
    while (tempEl != null)
    {
      if (QNameUtils.matches(Constants.Q_ELEM_DOCUMENTATION, tempEl))
      {
        output.addDocumentationElement(tempEl);
      }
      else
      {
    ...
    throws WSDLException
  {
    ...
    while (tempEl != null)
    {
      if (QNameUtils.matches(Constants.Q_ELEM_DOCUMENTATION, tempEl))
      {
        fault.addDocumentationElement(tempEl);
      }
      else
      {
