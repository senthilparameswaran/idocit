...
public class JavaInterfaceParserTest
{
	 ...
	 */
	private static final String EXPECTED_CLASS_STRUCTURE_TEST = AllIDocItJavaTests.SOURCE_DIR + "test.java [Artifact]\n";

	/**
	 * Class with two methods.
	 */
	private static final String EXPECTED_CLASS_STRUCTURE_PARSING_SERVICE = AllIDocItJavaTests.SOURCE_DIR + "ParsingService.java [Artifact]\n"
	 ...
	 */
	private static final String EXPECTED_CLASS_STRUCTURE_TYPE_RECURSION = AllIDocItJavaTests.SOURCE_DIR + "TypeRecursion.java [Artifact]\n"
			+ "	TypeRecursion [Class]\n"
			+ "		test [Method]\n"
			+ "			 [Parameters]\n"
	 ...
	 */
	private static final String EXPECTED_CLASS_STRUCTURE_TEST_RECURSION = AllIDocItJavaTests.SOURCE_DIR + "TestRecursion.java [Artifact]\n"
			+ "	TestRecursion [Class]\n"
	...
	public void testParse() throws Exception
	{
		Assert.assertEquals(EXPECTED_CLASS_STRUCTURE_PARSING_SERVICE,
				testParseWith(AllIDocItJavaTests.SOURCE_DIR + "ParsingService.java"));

		Assert.assertEquals(EXPECTED_CLASS_STRUCTURE_TEST,
				testParseWith(AllIDocItJavaTests.SOURCE_DIR + "test.java"));

		Assert.assertEquals(EXPECTED_CLASS_STRUCTURE_TYPE_RECURSION,
				testParseWith(AllIDocItJavaTests.SOURCE_DIR + "TypeRecursion.java"));

		Assert.assertEquals(EXPECTED_CLASS_STRUCTURE_TEST_RECURSION,
				testParseWith(AllIDocItJavaTests.SOURCE_DIR + "TestRecursion.java"));
	}
	...
	{
		String testFileName = AllIDocItJavaTests.SOURCE_DIR + "JavaInterfaceParser.java";
